  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 font-sans">
      ...
      <main>
        ...
        {currentView === 'dashboard' && currentUser === 'admin' && <DashboardPage />}
        {currentView === 'admin' && currentUser === 'admin' && <AdminPage onPollCreated={handlePollCreated} />}
        {currentView === 'user-management' && currentUser === 'admin' && <UserManagementPage />}
      </main>
    </div>
  );
}
